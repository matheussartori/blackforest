package com.sartori.blackforest.tools;
...
public enum BlackForestItemTier implements IItemTier {
    ...
    BlackForestItemTier(int harvestLevel, int maxUses, float efficiency, float attackDamage, int enchantability, Supplier<Ingredient> repairMaterial) {
